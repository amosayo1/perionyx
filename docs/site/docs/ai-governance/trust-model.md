...
### FinancialTransactionManager Invariance
...
| 17 | No forbidden practices are present (see Forbidden Practices) | Code review |
...
Violations of forbidden practices require immediate PR rejection and a team review of the AI implementation process.
