...
sidebar_label: Financial Engine
description: Double-entry accounting, journal lifecycle, validation, posting, reconciliation, reversal, and audit trail for the Perionyx ledger.
---
