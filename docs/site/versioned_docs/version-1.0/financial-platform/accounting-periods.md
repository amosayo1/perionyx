...
sidebar_label: Accounting Periods
description: Fiscal years, accounting periods, and the period close process — flexible fiscal calendars, soft/hard close workflows, and period locking for audit integrity.
---
