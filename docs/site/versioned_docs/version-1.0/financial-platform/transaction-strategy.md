...
sidebar_label: Transaction Strategy
description: Enterprise transaction strategy for all financial write operations — ACID guarantees, PostgreSQL isolation levels, row locking, optimistic locking, deadlock handling, and retry logic.
---
...
### 11.1 Audit Record Completeness
...
## 12. Transaction Guarantees Summary
