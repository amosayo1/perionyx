...
description: The foundational structure for all financial recording — hierarchical account tree with 10 primary account types, control accounts, and multi-company support.
---
