...
import { GitBranch, Activity, BarChart3, Landmark, Settings, Code } from "lucide-react";

const links = [
  { href: "/integrations", label: "Integration Hub", icon: GitBranch, desc: "Connected systems" },
  ...
  { href: "/settings/api-keys", label: "API Keys", icon: Code, desc: "API key management" },
];
