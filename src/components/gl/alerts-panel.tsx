...
import type { GLAlert } from "./gl-types";
...
const SEVERITY_CONFIG: Record<string, { icon: React.ComponentType<{ className?: string }>; color: string; border: string; bg: string; dot: string }> = {
