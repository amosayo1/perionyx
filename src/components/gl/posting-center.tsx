  ...
  return (
    <div className={cn("space-y-4", className)}>
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={onCreate}
          className="flex items-center gap-1.5 rounded-md bg-gold px-3 py-1.5 text-xs font-semibold text-black transition-colors hover:bg-[#c49f2e]"
        >
            ...
            {batches.length === 0 ? (
              ...
              batches.map((b) => (
                <tr key={b.id} className="transition-colors hover:bg-zinc-800/40">
                  ...
                  <td className="px-4 py-3 text-right text-sm font-mono text-gold">{formatCurrency(b.totalDebit)}</td>
