  ...
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        "bg-gradient-to-b from-zinc-900/50 to-black/40",
...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "flex flex-col gap-1.5 px-6 py-5 border-b border-white/[0.06]",
        className,
      )}
      {...props}
    />
...
const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("flex items-center px-6 py-5 border-t border-white/[0.06]", className)} {...props} />
  ),
);
