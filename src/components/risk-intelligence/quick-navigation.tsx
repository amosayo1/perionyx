...
import { Shield, ScrollText, BarChart3, FileText, Monitor, Activity } from "lucide-react";

const links = [
  { href: "/risk", label: "Risk", icon: Shield, desc: "Operational risk management" },
  { href: "/audit-logs", label: "Audit", icon: ScrollText, desc: "Event trail and controls" },
