...
import { BarChart3, FileText, Shield, Monitor, Activity, Terminal } from "lucide-react";

const links = [
  { href: "/insights", label: "Executive Insights", icon: BarChart3, desc: "Strategic intelligence" },
  { href: "/reports", label: "Reports", icon: FileText, desc: "Reports and exports" },
  { href: "/risk-intelligence", label: "Risk Intelligence", icon: Shield, desc: "Enterprise risk monitoring" },
  { href: "/operations", label: "Operations", icon: Monitor, desc: "Mission control" },
  { href: "/platform", label: "Platform Health", icon: Activity, desc: "Service monitoring" },
  { href: "/developer", label: "Developer Portal", icon: Terminal, desc: "API and SDK" },
];
