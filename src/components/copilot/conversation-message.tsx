    ...
    <div className={cn("flex gap-3 px-4 py-3", isAssistant ? "bg-white/[0.02]" : "")}>
      <div
        className={cn(
          ...
          isAssistant ? "bg-gold/10 text-gold" : "bg-zinc-800 text-zinc-400",
        )}
      >
          ...
          <div className="flex flex-wrap gap-1.5 pt-2">
            ...
            {message.followUps!.map((f) => (
              <button
                ...
                className="group inline-flex items-center gap-1 rounded-full border border-white/[0.06] bg-zinc-900/60 px-2.5 py-1 text-[11px] text-zinc-500 transition-all hover:border-gold/20 hover:text-gold"
              >
                {f}
