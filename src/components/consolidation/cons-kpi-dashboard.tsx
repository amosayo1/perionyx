...
import type { ConsKPIDashboardProps } from "./cons-types";
...
const categoryOrder = ["speed", "quality", "compliance", "efficiency", "coverage"] as const;

export default function ConsKPIDashboard({ metrics }: ConsKPIDashboardProps) {
