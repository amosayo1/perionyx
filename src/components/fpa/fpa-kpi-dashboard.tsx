...
import type { FPAKPIDashboardProps } from './fpa-types'
...
const categoryOrder = ['budget', 'forecast', 'variance', 'workforce', 'capital', 'cash'] as const

export default function FPAKPIDashboard({ metrics }: FPAKPIDashboardProps) {
  ...
  return (
    ...
    >
      <h3 style={{ color: '#e0e0e0', fontSize: 18, fontWeight: 700, margin: 0 }}>Planning KPIs</h3>
      {grouped.map((g) => (
