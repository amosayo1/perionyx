...
import { Activity, Monitor, BarChart3, Landmark, Settings, Code } from "lucide-react";
...
const links = [
  ...
  { href: "/settings/api-keys", label: "Developer APIs", icon: Code, desc: "API keys and tokens" },
];
  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <p className="text-xs text-zinc-500 mt-0.5">Jump to related modules</p>
      </div>
