...
export const ExecutiveTaxHeader = memo(function ExecutiveTaxHeader(props: ExecutiveTaxHeaderProps) {
  const cards = [
    { label: "Total Tax Liability", value: formatCurrency(props.totalTaxLiability), icon: <DollarSign className="h-4 w-4 text-[#d4af37]" />, color: "gold" as const, gold: true },
    { label: "Effective Tax Rate", value: `${props.effectiveTaxRate.toFixed(1)}%`, icon: <Percent className="h-4 w-4 text-[#d4af37]" />, color: "gold" as const, gold: true },
