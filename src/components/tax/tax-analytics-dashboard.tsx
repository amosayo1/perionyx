...
import type { TaxKPI } from "./tax-types";
...
function formatKpiValue(value: number, unit: string): string {
  ...
  if (unit === "count" || unit === "ratio") return value.toLocaleString();
  return `${value}${unit}`;
}

export const TaxAnalyticsDashboard = memo(function TaxAnalyticsDashboard({ kpis, className }: TaxAnalyticsDashboardProps) {
