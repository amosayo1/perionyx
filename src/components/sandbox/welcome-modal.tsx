      ...
      {visible && !welcomeDismissed && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-2xl rounded-2xl border border-[#d4af37]/15 bg-zinc-900/95 p-8 shadow-2xl backdrop-blur-xl"
          >
            <div className="absolute -top-px left-8 right-8 h-px bg-gradient-to-r from-transparent via-[#d4af37]/40 to-transparent" />

            <div className="flex items-center gap-3 mb-6">
              <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#d4af37]/10 border border-[#d4af37]/20">
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              ...
              <div className="rounded-xl border border-white/[0.06] bg-white/[0.03] p-4">
                <DollarSign className="h-4 w-4 text-[#d4af37] mb-2" />
            ...
            <div className="space-y-2.5">
              <button
                ...
                className="group flex w-full items-center gap-3 rounded-xl bg-[#d4af37] px-5 py-3.5 text-sm font-bold text-black transition-all hover:bg-[#d4af37]/90"
              >
