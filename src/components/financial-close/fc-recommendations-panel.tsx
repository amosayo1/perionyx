...
import type { FCRecommendationsPanelProps } from "./fc-types"
...
const typeIcons: Record<string, string> = { task: "\u2699", reconciliation: "\u2194\uFE0F", approval: "\u2714\uFE0F", variance: "%", risk: "\u26A0\uFE0F", process: "\u21BB" }
const priorityOrder = ["critical", "high", "medium", "low"]

export function FCRecommendationsPanel({ recommendations }: FCRecommendationsPanelProps) {
  ...
  return (
    <div>
      ...
      {Object.keys(groups).length === 0 ? (
        <div style={{ color: "#64748b", fontSize: 13, textAlign: "center", padding: 40 }}>No active recommendations</div>
      ) : (
