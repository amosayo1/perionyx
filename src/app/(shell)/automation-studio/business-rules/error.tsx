...
export default function BusinessRulesError({
  error,
  reset,
}: {
  ...
  useEffect(() => { console.error("Business rules error:", error); }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-white">Business Rules Error</h1>
        <p className="mt-2 text-sm text-zinc-500 leading-relaxed">
          Something went wrong loading business rules.
        </p>
        <button
          onClick={reset}
