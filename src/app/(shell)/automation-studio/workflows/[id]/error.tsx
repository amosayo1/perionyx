...
export default function WorkflowIdError({
  error,
  reset,
}: {
  ...
  useEffect(() => { console.error("Workflow error:", error); }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-white">Workflow Error</h1>
