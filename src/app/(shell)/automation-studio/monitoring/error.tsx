...
export default function MonitoringError({
  ...
  useEffect(() => { console.error("Monitoring error:", error); }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-white">Monitoring Error</h1>
        <p className="mt-2 text-sm text-zinc-500 leading-relaxed">
          Something went wrong loading monitoring data.
        </p>
        <button
          onClick={reset}
