...
export default function AutomationStudioError({
  error,
  reset,
}: {
  ...
  useEffect(() => { console.error("Automation Studio error:", error); }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-white">Dashboard Error</h1>
        <p className="mt-2 text-sm text-zinc-500 leading-relaxed">
          Something went wrong loading the automation studio dashboard.
        </p>
        <button
          onClick={reset}
