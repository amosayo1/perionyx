...
export default function DesignerError({
  ...
  useEffect(() => { console.error("Designer error:", error); }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-white">Workflow Designer Error</h1>
        <p className="mt-2 text-sm text-zinc-500 leading-relaxed">
          Something went wrong loading the workflow designer.
        </p>
        <button
          onClick={reset}
