...
export default function ConsExecutivePage() {
  ...
  return (
    <PageContainer>
      <EnterprisePageHeader title="Executive Overview" description="High-level consolidation status and strategic insights" />
