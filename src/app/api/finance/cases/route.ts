...
export async function GET(req: Request) {
  try {
    ...
    const data = await FinanceCollaborationService.getCaseManagement(ctx, parsed.data);
...
export async function POST(req: Request) {
  try {
    ...
    const data = await FinanceCollaborationService.getCaseManagement(ctx, parsed.data as any);
