...
import { disputeInvoiceSchema } from "@/lib/validations/ap";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const result = await invoiceService.disputeInvoice({ invoiceId, disputeReason: parsed.data.disputeReason }, commandCtx);
