...
import { voidInvoiceSchema } from "@/lib/validations/ap";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    await apRequirePermission(tenant, "ap.invoices.delete");
    ...
    const result = await invoiceService.voidInvoice({ invoiceId, reason: parsed.data.reason }, commandCtx);
