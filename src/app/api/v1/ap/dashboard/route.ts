...
export async function GET(req: Request) {
  ...
  try {
    ...
    const response = NextResponse.json({ data: { totalOutstanding: "0", pendingApproval: 0, pendingPayment: "0", exceptionsOpen: 0, avgCycleTime: 0, discountCaptureRate: 0, topVendors: [], cashReqNext30: "0" } }, { status: 200, headers: cacheHeaders(30) });
