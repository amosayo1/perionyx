...
export async function GET(req: Request) {
  ...
  try {
    ...
    const response = NextResponse.json({ data: { summary: { totalOutstanding: "0", current: "0", days30: "0", days60: "0", days90: "0", days120Plus: "0" }, vendors: [] } }, { status: 200, headers: cacheHeaders(60) });
