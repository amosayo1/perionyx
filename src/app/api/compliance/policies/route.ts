...
import { getPoliciesQuerySchema, createPolicySchema } from "@/lib/validations/compliance-specialist";
...
export async function POST(req: Request) {
  return withRuntimeContext(req, async (ctx) => {
    try {
      ...
      const result = await PolicyEngineService.createPolicy(ctx.tenant, parsed.data);
